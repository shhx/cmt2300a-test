...
#define CMT2300A_MASK_NODE_MODE          0x03
enum CMT2300A_NodeModes {
    CMT2300A_NODE_MODE_NONE = 0,
    CMT2300A_NODE_MODE_NODE_DETECT,
    CMT2300A_NODE_MODE_NODE_0X00,
    CMT2300A_NODE_MODE_NODE_0X00_0XFF
};
