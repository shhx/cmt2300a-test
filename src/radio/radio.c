 ...
 * CONSEQUENTLY, ** SHALL NOT BE HELD LIABLE FOR ANY DIRECT, INDIRECT OR
...
static uint8_t g_nInterruptFlags = 0;
...
EnumRFResult RF_Process(void)
{
    ...
    case RF_STATE_RX_DONE:
    {
        ...
        g_nInterruptFlags = CMT2300A_ClearInterruptFlags();
